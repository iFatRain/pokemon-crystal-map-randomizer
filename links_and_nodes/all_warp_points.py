...
class Azalea_Town_Links(Enum):
    ...
    AZALEA_TOWN_TO_SLOWPOKE_WELL_B1F_LINK = WarpLink(
        ...
        Slowpoke_Well_B1F_Warp_Points.SLOWPOKE_WELL_B1_F_TO_AZALEA_TOWN_6_WP,
...
class Ruins_Of_Alph_Outside_Links(Enum):
    RUINS_OF_ALPH_OUTSIDE_TO_RUINS_OF_ALPH_RESEARCH_CENTER_LINK = WarpLink(
        Ruins_Of_Alph_Outside_Warp_Points.RUINS_OF_ALPH_OUTSIDE_TO_RUINS_OF_ALPH_RESEARCH_CENTER_WP,
        Ruins_Of_Alph_Research_Center_Warp_Points.RUINS_OF_ALPH_RESEARCH_CENTER_TO_RUINS_OF_ALPH_OUTSIDE_WP,
        "RuinsOfAlphOutside" , 25
    )

    RUINS_OF_ALPH_OUTSIDE_TO_ROUTE_36_RUINS_OF_ALPH_GATE_LINK = WarpLink(
        Ruins_Of_Alph_Outside_Warp_Points.RUINS_OF_ALPH_OUTSIDE_TO_ROUTE_36_RUINS_OF_ALPH_GATE_WP,
        Route_36_Ruins_Of_Alph_Gate_Warp_Points.ROUTE_36_RUINS_OF_ALPH_GATE_TO_RUINS_OF_ALPH_OUTSIDE_WP,
        "RuinsOfAlphOutside" , 40
    )

    RUINS_OF_ALPH_OUTSIDE_TO_ROUTE_32_RUINS_OF_ALPH_GATE_LINK = WarpLink(
        Ruins_Of_Alph_Outside_Warp_Points.RUINS_OF_ALPH_OUTSIDE_TO_ROUTE_32_RUINS_OF_ALPH_GATE_WP,
...
class Slowpoke_Well_B1F_Links(Enum):
    ...
    #     Slowpoke_Well_B1F_Warp_Points.SLOWPOKE_WELL_B1F_TO_SLOWPOKE_WELL_B2F_WP
    #     0x0005AC89 , 5
    # )
...
# class Route_39_Links(Enum):
    ...
    #     Route_39_Barn_Warp_Points.ROUTE_39_BARN_TO_ROUTE_39_WP,
    #     0x001A60BF
    # )
    # ROUTE_39_TO_ROUTE_39_FARMHOUSE_LINK = WarpLink(
    #     Route_39_Warp_Points.ROUTE_39_TO_ROUTE_39_FARMHOUSE_WP,
    #     Route_39_Farmhouse_Warp_Points.ROUTE_39_FARMHOUSE_TO_ROUTE_39,
    #     0x001A60BF , 5
    # )
...
class Dark_Cave_Violet_Entrance_Links(Enum):
    ...
    # DARK_CAVE_VIOLET_ENTRANCE_TO_DARK_CAVE_BLACKTHORN_ENTRANCE_LINK = WarpLink(
    #     Dark_Cave_Violet_Entrance_Warp_Points.DARK_CAVE_VIOLET_ENTRANCE_TO_DARK_CAVE_BLACKTHORN_ENTRANCE_WP,
    #     New_Bark_Warp_Points.NEW_BARK_TO_PLAYERS_HOUSE,
    #     0x0018C6A1 , 5
    # )
    #
    # DARK_CAVE_VIOLET_ENTRANCE_TO_ROUTE_46_LINK = WarpLink(
